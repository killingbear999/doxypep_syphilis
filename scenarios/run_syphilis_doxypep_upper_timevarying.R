...
run_doxypep <- function(p_DbE, p_DoD_H, p_DoD_L, p_DoS_H, p_DoS_L) {
  ...
  # load baseline cases
  cases_baseline <- readRDS(file="cases_baseline_varying_main.Rda")
  ...
  cases_baseline_primary <- readRDS(file="cases_baseline_primary_varying_main.Rda")
  ...
  cases_baseline_secondary <- readRDS(file="cases_baseline_secondary_varying_main.Rda")
  ...
  cases_baseline_others <- readRDS(file="cases_baseline_others_varying_main.Rda")
  ...
  cases_baseline_diagnosed <- readRDS(file="cases_baseline_diagnosed_varying_main.Rda")
  ...
  df_baseline <- readRDS(file="data_baseline_varying_main.Rda")
