...
run_doxypep <- function(p_DbE, p_DoD_H, p_DoD_L, p_DoS_H, p_DoS_L, u) {
  ...
  cases_baseline_diagnosed <- readRDS(file="cases_baseline_diagnosed_fixed_main.Rda")
...
u = 0.5
# DbE
result_DbE <- run_doxypep(p_DbE = uptake, p_DoD_H = 0, p_DoD_L = 0, p_DoS_H = 0, p_DoS_L = 0, u = u)
...
# DoD(H)
result_DoD_H <- run_doxypep(p_DbE = 0, p_DoD_H = uptake, p_DoD_L = 0, p_DoS_H = 0, p_DoS_L = 0, u = u)
...
# DoD
result_DoD <- run_doxypep(p_DbE = 0, p_DoD_H = uptake, p_DoD_L = uptake, p_DoS_H = 0, p_DoS_L = 0, u = u)
...
# DoA(H)
result_DoA_H <- run_doxypep(p_DbE = 0, p_DoD_H = uptake, p_DoD_L = 0, p_DoS_H = uptake, p_DoS_L = 0, u = u)
...
# DoA
result_DoA <- run_doxypep(p_DbE = 0, p_DoD_H = uptake, p_DoD_L = uptake, p_DoS_H = uptake, p_DoS_L = uptake, u = u)
...
# DaR
result_DaR <- run_doxypep(p_DbE = 0, p_DoD_H = uptake, p_DoD_L = uptake, p_DoS_H = uptake, p_DoS_L = 0, u = u)
...
############################################################## plot cases ##############################################################
# load("workspace_0.66_highbehavioural_fixed_uk.RData")
...
save.image("workspace_0.66_highbehavioural_fixed_uk.RData")
