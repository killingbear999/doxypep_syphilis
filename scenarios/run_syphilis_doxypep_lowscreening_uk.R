...
doxypep_model <- function(t, y, parameters) {
  with(as.list(c(y, parameters)), {
    ...
    eta_H <- 0.184 # get_eta(t, t_0, eta_H_init, phi_eta, isFixed)
    eta_L <- omega * eta_H
...
run_doxypep <- function(p_DbE, p_DoD_H, p_DoD_L, p_DoS_H, p_DoS_L) {
  ...
  # load baseline cases
  cases_baseline <- readRDS(file="cases_baseline_lowscreening_fixed_main.Rda")
  ...
  cases_baseline_primary <- readRDS(file="cases_baseline_lowscreening_primary_fixed_main.Rda")
  ...
  cases_baseline_secondary <- readRDS(file="cases_baseline_lowscreening_secondary_fixed_main.Rda")
  ...
  cases_baseline_others <- readRDS(file="cases_baseline_lowscreening_others_fixed_main.Rda")
  ...
  cases_baseline_diagnosed <- readRDS(file="cases_baseline_lowscreening_diagnosed_fixed_main.Rda")
  ...
  df_baseline <- readRDS(file="data_baseline_lowscreening_fixed_main.Rda")
...
# save.image("workspace_0.66_lowscreening_fixed_uk.RData")
load(("workspace_0.10_lowscreening_fixed_uk.RData"))